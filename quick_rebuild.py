...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / 'quick_rebuild.log'),
...
def cleanup_old_files():
    ...
    if deleted_count == 0:
        print("  ✓ No old files to delete (already clean)")
    else:
...
def main():
    ...
    print('    python3 -c "from src.search_engine import SemanticSearchEngine; '
          'engine = SemanticSearchEngine(); '
          'results = engine.search(\'achilles tendon rupture treatment\', top_k=5); '
